...
export CONFIG_FILE="configs/armv8-mini.config"
export DIY_SCRIPT="diy-mini.sh"
...
echo "Starting Manual Build for ARMv8 Mini OpenWrt"
...
echo "You can check ophub/flippy-openwrt-actions for manual packaging instructions if needed."
